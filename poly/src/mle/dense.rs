...
#[cfg(feature = "rand")]
use crate::mle::MultilinearExtensionRand;
use crate::{EvaluationError, add, mle::MultilinearExtension, sub};
use ark_std::log2;
use crypto_primitives_algebra::{Matrix, MulByScalar, Ring, Semiring};
#[cfg(feature = "rand")]
...
{
    fn rand<Rng: rand::RngCore + ?Sized>(num_vars: usize, rng: &mut Rng, zero: R) -> Self {
